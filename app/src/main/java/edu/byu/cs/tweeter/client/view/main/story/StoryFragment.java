...
import edu.byu.cs.tweeter.client.presenter.main.story.StoryPresenter;
        ...
        StoryHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    presenter.onStoryItemClick(userAlias.getText().toString());
                }
            });
        }
        ...
        public void onScrolled(@NotNull RecyclerView recyclerView, int dx, int dy) {
            ...
            if (!presenter.isLoading() && presenter.hasMorePages()) {
                if ((visibleItemCount + firstVisibleItemPosition) >=
                    ...
                    handler.postDelayed(() -> {
                        storyRecyclerViewAdapter.onScrolled();
                    }, 0);
                }
            }
        }
